                     ...
                     _In_ int       nCmdShow)
{
    ...
    // GetMessage - False반환시 프로그램 종료
    // 메세지큐에서 메세지 확인할 때까지 대기
    // 'msg.message == WM_QUIT'일때 False 반환
    ...
    // PeekMessage
    // 메세지 유무와 관계없이 반환
    // 메세지큐에서 메세질를 확인한 경우 true, 메세지 큐에 메세지가 없는 경우 false 반환
    while (true)
    {
